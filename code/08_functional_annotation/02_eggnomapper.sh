...
PROTEINS_FILE="$SRC_DIR/analyses/08_functional_annotation/01_get_transcripts/braker.aa"
...
emapper.py -i "$PROTEINS_FILE" \
  ...
  --output n_japonicum \
  --output_dir "$JOB_DIR" \
  --decorate_gff "$SRC_DIR/analyses/07_structural_annotation/braker.gff3" \
